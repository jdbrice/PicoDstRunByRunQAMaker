...
#ifndef PICO_DST_RUN14_AUAU_200_h
#define PICO_DST_RUN14_AUAU_200_h
...
public :
	...
	PicoDstRun14AuAu200(TTree *tree=0);
	virtual ~PicoDstRun14AuAu200();
	...
	T get( std::string var, unsigned int i = 0, unsigned int j = 0, unsigned int k = 0 ) {
		...
		else if (var == "Event_" ) return Event_;
		else if (var == "Event.mRunId" ) return Event_mRunId[0];
		else if (var == "Event.mEventId" ) return Event_mEventId[0];
		else if (var == "Event.mFillId" ) return Event_mFillId[0];
		else if (var == "Event.mBField" ) return Event_mBField[0];
		else if (var == "Event.mPrimaryVertex.mX1" ) return Event_mPrimaryVertex_mX1[0];
		else if (var == "Event.mPrimaryVertex.mX2" ) return Event_mPrimaryVertex_mX2[0];
		else if (var == "Event.mPrimaryVertex.mX3" ) return Event_mPrimaryVertex_mX3[0];
		else if (var == "Event.mSecondVertex.mX1" ) return Event_mSecondVertex_mX1[0];
		else if (var == "Event.mSecondVertex.mX2" ) return Event_mSecondVertex_mX2[0];
		else if (var == "Event.mSecondVertex.mX3" ) return Event_mSecondVertex_mX3[0];
		else if (var == "Event.mPrimaryVertexError.mX1" ) return Event_mPrimaryVertexError_mX1[0];
		else if (var == "Event.mPrimaryVertexError.mX2" ) return Event_mPrimaryVertexError_mX2[0];
		else if (var == "Event.mPrimaryVertexError.mX3" ) return Event_mPrimaryVertexError_mX3[0];
		else if (var == "Event.mTriggerWord" ) return Event_mTriggerWord[0];
		else if (var == "Event.mTriggerWordMtd" ) return Event_mTriggerWordMtd[0];
		else if (var == "Event.mRefMultFtpcEast" ) return Event_mRefMultFtpcEast[0];
		else if (var == "Event.mRefMultFtpcWest" ) return Event_mRefMultFtpcWest[0];
		else if (var == "Event.mRefMultNeg" ) return Event_mRefMultNeg[0];
		else if (var == "Event.mRefMultPos" ) return Event_mRefMultPos[0];
		else if (var == "Event.mRefMult2NegEast" ) return Event_mRefMult2NegEast[0];
		else if (var == "Event.mRefMult2PosEast" ) return Event_mRefMult2PosEast[0];
		else if (var == "Event.mRefMult2NegWest" ) return Event_mRefMult2NegWest[0];
		else if (var == "Event.mRefMult2PosWest" ) return Event_mRefMult2PosWest[0];
		else if (var == "Event.mRefMultHalfNegEast" ) return Event_mRefMultHalfNegEast[0];
		else if (var == "Event.mRefMultHalfPosEast" ) return Event_mRefMultHalfPosEast[0];
		else if (var == "Event.mRefMultHalfNegWest" ) return Event_mRefMultHalfNegWest[0];
		else if (var == "Event.mRefMultHalfPosWest" ) return Event_mRefMultHalfPosWest[0];
		else if (var == "Event.mGRefMult" ) return Event_mGRefMult[0];
		else if (var == "Event.mNHitsHFT" ) return Event_mNHitsHFT[0][i];
		else if (var == "Event.mNVpdHitsEast" ) return Event_mNVpdHitsEast[0];
		else if (var == "Event.mNVpdHitsWest" ) return Event_mNVpdHitsWest[0];
		else if (var == "Event.mNT0" ) return Event_mNT0[0];
		else if (var == "Event.mVzVpd" ) return Event_mVzVpd[0];
		else if (var == "Event.mZDCx" ) return Event_mZDCx[0];
		else if (var == "Event.mBBCx" ) return Event_mBBCx[0];
		else if (var == "Event.mBackgroundRate" ) return Event_mBackgroundRate[0];
		else if (var == "Event.mBbcBlueBackgroundRate" ) return Event_mBbcBlueBackgroundRate[0];
		else if (var == "Event.mBbcYellowBackgroundRate" ) return Event_mBbcYellowBackgroundRate[0];
		else if (var == "Event.mBbcEastRate" ) return Event_mBbcEastRate[0];
		else if (var == "Event.mBbcWestRate" ) return Event_mBbcWestRate[0];
		else if (var == "Event.mZdcEastRate" ) return Event_mZdcEastRate[0];
		else if (var == "Event.mZdcWestRate" ) return Event_mZdcWestRate[0];
		else if (var == "Event.mVpd" ) return Event_mVpd[0][i];
		else if (var == "Event.mZdcSumAdcEast" ) return Event_mZdcSumAdcEast[0];
		else if (var == "Event.mZdcSumAdcWest" ) return Event_mZdcSumAdcWest[0];
		else if (var == "Event.mZdcSmdEastHorizontal" ) return Event_mZdcSmdEastHorizontal[0][i];
		else if (var == "Event.mZdcSmdEastVertical" ) return Event_mZdcSmdEastVertical[0][i];
		else if (var == "Event.mZdcSmdWestHorizontal" ) return Event_mZdcSmdWestHorizontal[0][i];
		else if (var == "Event.mZdcSmdWestVertical" ) return Event_mZdcSmdWestVertical[0][i];
		else if (var == "Event.mSpaceCharge" ) return Event_mSpaceCharge[0];
		else if (var == "Event.mbTofTrayMultiplicity" ) return Event_mbTofTrayMultiplicity[0];
		else if (var == "Event.mNumberOfGlobalTracks" ) return Event_mNumberOfGlobalTracks[0];
		else if (var == "Event.mRanking" ) return Event_mRanking[0];
		else if (var == "Event.mNBEMCMatch" ) return Event_mNBEMCMatch[0];
		else if (var == "Event.mNBTOFMatch" ) return Event_mNBTOFMatch[0];
		else if (var == "Event.mBbcAdcEast" ) return Event_mBbcAdcEast[0][i];
		else if (var == "Event.mBbcAdcWest" ) return Event_mBbcAdcWest[0][i];
		else if (var == "Event.mHT_Th" ) return Event_mHT_Th[0][i];
		else if (var == "Event.mJP_Th" ) return Event_mJP_Th[0][i];
		else if (var == "EventPlane_" ) return EventPlane_;
		else if (var == "EventPlane.fUniqueID" ) return EventPlane_fUniqueID[0];
		else if (var == "EventPlane.fBits" ) return EventPlane_fBits[0];
		else if (var == "EventPlane.mQx_eta_pos" ) return EventPlane_mQx_eta_pos[0];
		else if (var == "EventPlane.mQy_eta_pos" ) return EventPlane_mQy_eta_pos[0];
		else if (var == "EventPlane.mQx_eta_neg" ) return EventPlane_mQx_eta_neg[0];
		else if (var == "EventPlane.mQy_eta_neg" ) return EventPlane_mQy_eta_neg[0];
		else if (var == "EventPlane.mNtrk_eta_pos" ) return EventPlane_mNtrk_eta_pos[0];
		else if (var == "EventPlane.mNtrk_eta_neg" ) return EventPlane_mNtrk_eta_neg[0];
		else if (var == "EventPlane.mWeight_eta_pos" ) return EventPlane_mWeight_eta_pos[0];
		else if (var == "EventPlane.mWeight_eta_neg" ) return EventPlane_mWeight_eta_neg[0];
		else if (var == "EventPlane.mQx_chg_pos" ) return EventPlane_mQx_chg_pos[0];
		else if (var == "EventPlane.mQy_chg_pos" ) return EventPlane_mQy_chg_pos[0];
		else if (var == "EventPlane.mQx_chg_neg" ) return EventPlane_mQx_chg_neg[0];
		else if (var == "EventPlane.mQy_chg_neg" ) return EventPlane_mQy_chg_neg[0];
		else if (var == "EventPlane.mNtrk_chg_pos_eta_pos" ) return EventPlane_mNtrk_chg_pos_eta_pos[0];
		else if (var == "EventPlane.mNtrk_chg_pos_eta_neg" ) return EventPlane_mNtrk_chg_pos_eta_neg[0];
		else if (var == "EventPlane.mNtrk_chg_neg_eta_pos" ) return EventPlane_mNtrk_chg_neg_eta_pos[0];
		else if (var == "EventPlane.mNtrk_chg_neg_eta_neg" ) return EventPlane_mNtrk_chg_neg_eta_neg[0];
		else if (var == "EventPlane.mWeight_chg_pos" ) return EventPlane_mWeight_chg_pos[0];
		else if (var == "EventPlane.mWeight_chg_neg" ) return EventPlane_mWeight_chg_neg[0];
		else if (var == "EventPlane.mQx_ran_1" ) return EventPlane_mQx_ran_1[0];
		else if (var == "EventPlane.mQy_ran_1" ) return EventPlane_mQy_ran_1[0];
		else if (var == "EventPlane.mQx_ran_2" ) return EventPlane_mQx_ran_2[0];
		else if (var == "EventPlane.mQy_ran_2" ) return EventPlane_mQy_ran_2[0];
		else if (var == "EventPlane.mNtrk_ran_1_eta_pos" ) return EventPlane_mNtrk_ran_1_eta_pos[0];
		else if (var == "EventPlane.mNtrk_ran_1_eta_neg" ) return EventPlane_mNtrk_ran_1_eta_neg[0];
		else if (var == "EventPlane.mNtrk_ran_2_eta_pos" ) return EventPlane_mNtrk_ran_2_eta_pos[0];
		else if (var == "EventPlane.mNtrk_ran_2_eta_neg" ) return EventPlane_mNtrk_ran_2_eta_neg[0];
		else if (var == "EventPlane.mWeight_ran_1" ) return EventPlane_mWeight_ran_1[0];
		else if (var == "EventPlane.mWeight_ran_2" ) return EventPlane_mWeight_ran_2[0];
		else if (var == "Tracks_" ) return Tracks_;
		else if (var == "Tracks.mId" ) return Tracks_mId[i];
		else if (var == "Tracks.mChi2" ) return Tracks_mChi2[i];
		else if (var == "Tracks.mPMomentum.mX1" ) return Tracks_mPMomentum_mX1[i];
		else if (var == "Tracks.mPMomentum.mX2" ) return Tracks_mPMomentum_mX2[i];
		else if (var == "Tracks.mPMomentum.mX3" ) return Tracks_mPMomentum_mX3[i];
		else if (var == "Tracks.mDedx" ) return Tracks_mDedx[i];
		else if (var == "Tracks.mNHitsFit" ) return Tracks_mNHitsFit[i];
		else if (var == "Tracks.mNHitsMax" ) return Tracks_mNHitsMax[i];
		else if (var == "Tracks.mNHitsDedx" ) return Tracks_mNHitsDedx[i];
		else if (var == "Tracks.mNSigmaPion" ) return Tracks_mNSigmaPion[i];
		else if (var == "Tracks.mNSigmaKaon" ) return Tracks_mNSigmaKaon[i];
		else if (var == "Tracks.mNSigmaProton" ) return Tracks_mNSigmaProton[i];
		else if (var == "Tracks.mNSigmaElectron" ) return Tracks_mNSigmaElectron[i];
		// else if (var == "Tracks.mMap0" ) return Tracks_mMap0[i];
		// else if (var == "Tracks.mMap1" ) return Tracks_mMap1[i];
		// else if (var == "Tracks.mPar" ) return Tracks_mPar[i][j];
		// else if (var == "Tracks.mErrMatrix" ) return Tracks_mErrMatrix[i][j];
		else if (var == "Tracks.mEmcPidTraitsIndex" ) return Tracks_mEmcPidTraitsIndex[i];
		else if (var == "Tracks.mBTofPidTraitsIndex" ) return Tracks_mBTofPidTraitsIndex[i];
		else if (var == "Tracks.mMtdPidTraitsIndex" ) return Tracks_mMtdPidTraitsIndex[i];
		else if (var == "EmcTrigger_" ) return EmcTrigger_;
		else if (var == "EmcTrigger.fUniqueID" ) return EmcTrigger_fUniqueID[i];
		else if (var == "EmcTrigger.fBits" ) return EmcTrigger_fBits[i];
		else if (var == "EmcTrigger.mFlag" ) return EmcTrigger_mFlag[i];
		else if (var == "EmcTrigger.mId" ) return EmcTrigger_mId[i];
		else if (var == "EmcTrigger.mAdc" ) return EmcTrigger_mAdc[i];
		else if (var == "MtdTrigger_" ) return MtdTrigger_;
		else if (var == "MtdTrigger.fUniqueID" ) return MtdTrigger_fUniqueID[i];
		else if (var == "MtdTrigger.fBits" ) return MtdTrigger_fBits[i];
		else if (var == "MtdTrigger.mVpdTacSum" ) return MtdTrigger_mVpdTacSum[i];
		else if (var == "MtdTrigger.mQTtacSum" ) return MtdTrigger_mQTtacSum[i][j][k];
		else if (var == "MtdTrigger.mMT101Tac" ) return MtdTrigger_mMT101Tac[i][j][k];
		else if (var == "MtdTrigger.mMT101Id" ) return MtdTrigger_mMT101Id[i][j][k];
		else if (var == "MtdTrigger.mTF201TriggerBit" ) return MtdTrigger_mTF201TriggerBit[i];
		else if (var == "MtdTrigger.mShouldHaveRejectEvent" ) return MtdTrigger_mShouldHaveRejectEvent[i];
		else if (var == "BTOWHit_" ) return BTOWHit_;
		else if (var == "BTOWHit.fUniqueID" ) return BTOWHit_fUniqueID[i];
		else if (var == "BTOWHit.fBits" ) return BTOWHit_fBits[i];
		else if (var == "BTOWHit.mId" ) return BTOWHit_mId[i];
		else if (var == "BTOWHit.mAdc" ) return BTOWHit_mAdc[i];
		else if (var == "BTOWHit.mE" ) return BTOWHit_mE[i];
		else if (var == "BTofHit_" ) return BTofHit_;
		else if (var == "BTofHit.fUniqueID" ) return BTofHit_fUniqueID[i];
		else if (var == "BTofHit.fBits" ) return BTofHit_fBits[i];
		else if (var == "BTofHit.mId" ) return BTofHit_mId[i];
		else if (var == "MtdHit_" ) return MtdHit_;
		else if (var == "MtdHit.fUniqueID" ) return MtdHit_fUniqueID[i];
		else if (var == "MtdHit.fBits" ) return MtdHit_fBits[i];
		else if (var == "MtdHit.mgChannel" ) return MtdHit_mgChannel[i];
		else if (var == "MtdHit.mTriggerFlag" ) return MtdHit_mTriggerFlag[i];
		else if (var == "MtdHit.mLeadingEdgeTime_first" ) return MtdHit_mLeadingEdgeTime_first[i];
		else if (var == "MtdHit.mLeadingEdgeTime_second" ) return MtdHit_mLeadingEdgeTime_second[i];
		else if (var == "MtdHit.mTrailingEdgeTime_first" ) return MtdHit_mTrailingEdgeTime_first[i];
		else if (var == "MtdHit.mTrailingEdgeTime_second" ) return MtdHit_mTrailingEdgeTime_second[i];
		else if (var == "EmcPidTraits_" ) return EmcPidTraits_;
		else if (var == "EmcPidTraits.fUniqueID" ) return EmcPidTraits_fUniqueID[i];
		else if (var == "EmcPidTraits.fBits" ) return EmcPidTraits_fBits[i];
		else if (var == "EmcPidTraits.mTrackIndex" ) return EmcPidTraits_mTrackIndex[i];
		else if (var == "EmcPidTraits.mBEMCId" ) return EmcPidTraits_mBEMCId[i];
		else if (var == "EmcPidTraits.mBTOWADC0" ) return EmcPidTraits_mBTOWADC0[i];
		else if (var == "EmcPidTraits.mBTOWE0" ) return EmcPidTraits_mBTOWE0[i];
		else if (var == "EmcPidTraits.mBTOWE" ) return EmcPidTraits_mBTOWE[i];
		else if (var == "EmcPidTraits.mBEMCDistZ" ) return EmcPidTraits_mBEMCDistZ[i];
		else if (var == "EmcPidTraits.mBEMCDistPhi" ) return EmcPidTraits_mBEMCDistPhi[i];
		else if (var == "EmcPidTraits.mBSMDNEta" ) return EmcPidTraits_mBSMDNEta[i];
		else if (var == "EmcPidTraits.mBSMDNPhi" ) return EmcPidTraits_mBSMDNPhi[i];
		else if (var == "EmcPidTraits.mBTOWId" ) return EmcPidTraits_mBTOWId[i];
		else if (var == "EmcPidTraits.mBTOWId23" ) return EmcPidTraits_mBTOWId23[i];
		else if (var == "EmcPidTraits.mBTOWE1" ) return EmcPidTraits_mBTOWE1[i];
		else if (var == "EmcPidTraits.mBTOWE2" ) return EmcPidTraits_mBTOWE2[i];
		else if (var == "EmcPidTraits.mBTOWE3" ) return EmcPidTraits_mBTOWE3[i];
		else if (var == "EmcPidTraits.mBTOWDistEta" ) return EmcPidTraits_mBTOWDistEta[i];
		else if (var == "EmcPidTraits.mBTOWDistPhi" ) return EmcPidTraits_mBTOWDistPhi[i];
		else if (var == "BTofPidTraits_" ) return BTofPidTraits_;
		else if (var == "BTofPidTraits.fUniqueID" ) return BTofPidTraits_fUniqueID[i];
		else if (var == "BTofPidTraits.fBits" ) return BTofPidTraits_fBits[i];
		else if (var == "BTofPidTraits.mTrackIndex" ) return BTofPidTraits_mTrackIndex[i];
		else if (var == "BTofPidTraits.mBTofCellId" ) return BTofPidTraits_mBTofCellId[i];
		else if (var == "BTofPidTraits.mBTofMatchFlag" ) return BTofPidTraits_mBTofMatchFlag[i];
		else if (var == "BTofPidTraits.mBTof" ) return BTofPidTraits_mBTof[i];
		else if (var == "BTofPidTraits.mBTofBeta" ) return BTofPidTraits_mBTofBeta[i];
		else if (var == "BTofPidTraits.mBTofYLocal" ) return BTofPidTraits_mBTofYLocal[i];
		else if (var == "BTofPidTraits.mBTofZLocal" ) return BTofPidTraits_mBTofZLocal[i];
		else if (var == "BTofPidTraits.mBTofHitPosX" ) return BTofPidTraits_mBTofHitPosX[i];
		else if (var == "BTofPidTraits.mBTofHitPosY" ) return BTofPidTraits_mBTofHitPosY[i];
		else if (var == "BTofPidTraits.mBTofHitPosZ" ) return BTofPidTraits_mBTofHitPosZ[i];
		else if (var == "MtdPidTraits_" ) return MtdPidTraits_;
		else if (var == "MtdPidTraits.fUniqueID" ) return MtdPidTraits_fUniqueID[i];
		else if (var == "MtdPidTraits.fBits" ) return MtdPidTraits_fBits[i];
		else if (var == "MtdPidTraits.mMtdHitChan" ) return MtdPidTraits_mMtdHitChan[i];
		else if (var == "MtdPidTraits.mTrackIndex" ) return MtdPidTraits_mTrackIndex[i];
		else if (var == "MtdPidTraits.mMatchFlag" ) return MtdPidTraits_mMatchFlag[i];
		else if (var == "MtdPidTraits.mDeltaY" ) return MtdPidTraits_mDeltaY[i];
		else if (var == "MtdPidTraits.mDeltaZ" ) return MtdPidTraits_mDeltaZ[i];
		else if (var == "MtdPidTraits.mDeltaTimeOfFlight" ) return MtdPidTraits_mDeltaTimeOfFlight[i];
		else if (var == "MtdPidTraits.mBeta" ) return MtdPidTraits_mBeta[i];
