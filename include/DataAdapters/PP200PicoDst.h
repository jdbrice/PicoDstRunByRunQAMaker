...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxEmcTrigger = 1;
   static const Int_t kMaxMtdTrigger = 1;
   static const Int_t kMaxBTOWHit = 1;
   static const Int_t kMaxBTofHit = 1;
   static const Int_t kMaxMtdHit = 500;
   static const Int_t kMaxEmcPidTraits = 1;
   static const Int_t kMaxBTofPidTraits = 500;
   static const Int_t kMaxMtdPidTraits = 500;
 ...
 //StThreeVector<float> V0Lbar_mMomentum[2][kMaxV0Lbar];
   ...
   PP200PicoDst(TTree *tree=0);
   virtual ~PP200PicoDst();
